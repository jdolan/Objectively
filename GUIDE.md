...
A guide to installing Objectively and writing your first Class with it.

## Table of Contents

- [Installing](#installing)
- [Declaring a custom type](#declaring-a-custom-type)
- [Implementing a type](#implementing-a-type)
- [Using a type](#using-a-type)
- [Initialization](#initialization)
- [Invoking an instance method](#invoking-an-instance-method)
- [Invoking a Class method](#invoking-a-class-method)
...
## Declaring a custom type (.h file)
